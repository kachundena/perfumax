...
public class AgregarPerfumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszArea);
        ...
        ArrayAdapter<String> adapterOpiniones = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszOpiniones);
        ...
        ArrayAdapter<String> adapterListaDeseos = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszListaDeseos);
        ...
        ArrayAdapter<String> adapterFamilia = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszFamilia);
        ...
        ArrayAdapter<String> adapterEstela = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszEstela);
        ...
        ArrayAdapter<String> adapterValoracion = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszValoracion);
        ...
        ArrayAdapter<String> adapterDuracion = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszDuracion);
        ...
        ArrayAdapter<String> adapterPrioridad = new ArrayAdapter<String>(AgregarPerfumeActivity.this, android.R.layout.simple_spinner_item, arszPrioridad);
        ...
        btnGuardarCambios.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long filasModificadas = perfumesController.nuevoPerfume(perfumeConNuevosCambios);
                if (filasModificadas != 1) {
                    // De alguna forma ocurrió un error porque se debió modificar únicamente una fila
                    Toast.makeText(AgregarPerfumeActivity.this, "Error guardando cambios. Intente de nuevo.", Toast.LENGTH_SHORT).show();
                } else {
